  ...
  return (
    ...
    >
      <div className="px-6 sm:px-10 md:px-12 lg:px-14 max-w-7xl mx-auto pt-2 sm:pt-4 md:pt-6 pb-12 space-y-12">
        <motion.h1 variants={cardVariants} className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-center mb-12 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 leading-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <motion.section variants={cardVariants} aria-labelledby="why-join" className="bg-white/80 backdrop-blur-md rounded-3xl p-7 border border-blue-200/60 shadow-xl">
        ...
        <motion.section variants={cardVariants} className="bg-white/80 backdrop-blur-md rounded-3xl p-7 border border-blue-200/60 shadow-xl">
