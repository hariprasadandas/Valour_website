  ...
  <main className="text-gray-100 min-h-screen bg-gradient-to-b from-gray-900/90 via-gray-950 to-black">
    <div className="px-4 sm:px-6 md:px-8 max-w-7xl mx-auto py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div className="bg-gray-900/60 backdrop-blur-md rounded-xl p-6 border border-gray-700/50 hover:bg-gray-800/60 transition-all duration-200 shadow-lg">
      ...
      <section className="mt-16 bg-gray-900/60 backdrop-blur-md rounded-xl p-8 border border-gray-700/50">
        <h2 className="text-2xl font-bold text-white mb-6">How we work</h2>
        <ul className="space-y-3 list-disc pl-5 text-gray-300 mb-8">
