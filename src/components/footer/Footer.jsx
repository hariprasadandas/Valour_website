				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
					...
					<div className="w-full">
						...
						<ul className="space-y-2 text-sm">
							<li><a href="/about" className="text-white/90 hover:text-blue-200 transition-colors">About Us</a></li>
							<li><a href="/services" className="text-white/90 hover:text-blue-200 transition-colors">Services</a></li>
							<li><a href="/our-team" className="text-white/90 hover:text-blue-200 transition-colors">Leadership Team</a></li>
							<li><a href="/our-clients" className="text-white/90 hover:text-blue-200 transition-colors">Our Clients</a></li>
							<li><a href="/careers" className="text-white/90 hover:text-blue-200 transition-colors">Careers</a></li>
							<li><a href="/contact" className="text-white/90 hover:text-blue-200 transition-colors">Contact Us</a></li>
						</ul>
					</div>
					...
					<div className="w-full text-left md:text-right">
						...
						<div className="flex md:justify-end space-x-4 mb-4">
							<a href="#" className="text-white/90 hover:text-blue-200 transition-colors">
